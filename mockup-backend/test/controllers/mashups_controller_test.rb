...
class MashupsControllerTest < ActionController::TestCase
  ...
  test "should create mashup" do
    assert_difference('Mashup.count') do
      post :create, mashup: { name: @mashup.name, parameters: @mashup.parameters, user_id: @mashup.user_id }
    end
  ...
  test "should update mashup" do
    patch :update, id: @mashup, mashup: { name: @mashup.name, parameters: @mashup.parameters, user_id: @mashup.user_id }
    assert_redirected_to mashup_path(assigns(:mashup))
  end
