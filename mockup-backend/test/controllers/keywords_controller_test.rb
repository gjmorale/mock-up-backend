...
class KeywordsControllerTest < ActionController::TestCase
  ...
  test "should create keyword" do
    assert_difference('Keyword.count') do
      post :create, keyword: { keyword: @keyword.keyword, mashup_id: @keyword.mashup_id, value: @keyword.value }
    end
  ...
  test "should update keyword" do
    patch :update, id: @keyword, keyword: { keyword: @keyword.keyword, mashup_id: @keyword.mashup_id, value: @keyword.value }
    assert_redirected_to keyword_path(assigns(:keyword))
  end
